...
public class DemographyTesting {
	...
	public void testBirthsAreIncreasingPopSize() {
		...
		WorldBankCovid19Sim sim = helperFunctions.CreateDummySim("src/main/resources/testing/demography_params.txt");
		sim.start();
	...
	public void testDeathRatesAreSexDependent() {
		...
		WorldBankCovid19Sim sim_with_male_mortality = helperFunctions.CreateDummySimWithSeed(seed, "src/main/resources/testing/demography_params.txt");
		...
		WorldBankCovid19Sim sim_with_female_mortality = helperFunctions.CreateDummySimWithSeed(seed, "src/main/resources/testing/demography_params.txt");
		// turn off female mortality in this simulation
