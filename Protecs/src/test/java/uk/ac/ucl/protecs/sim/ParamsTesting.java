...
public class ParamsTesting {
	...
	public void testdailyTransitionWeekdayAndHomeRegionColumnOrderIsMutable() {
		...
		WorldBankCovid19Sim original_order_sim = helperFunctions.CreateDummySim("src/main/resources/testing/params_testing_odm_order.txt");
		original_order_sim.start();
		// Create the simulation with column order 'home_region,weekday,...' in the ODMs
		WorldBankCovid19Sim alternative_order_sim = helperFunctions.CreateDummySim("src/main/resources/testing/params_testing_odm_order_alt.txt");
	...
	public void testSimStartsWithoutDemographyFilenames() {
		...
		WorldBankCovid19Sim sim_no_demog_files = helperFunctions.CreateDummySim("src/main/resources/testing/params_testing_no_demography.txt");
	...
	public void testSimStartsWithoutLockdownFilenames() {
		...
		WorldBankCovid19Sim sim_no_lockdown_trigger_files = helperFunctions.CreateDummySim("src/main/resources/testing/params_testing_no_lockdown_filename.txt");
		// start the simulation, which triggers the loading in of parameters
	...
	public void testSimStartsWithoutCovidTestingFilenames() {
		// Create the simulation object without loading in lockdown triggering related filenames
		WorldBankCovid19Sim sim_no_covid_testing_files = helperFunctions.CreateDummySim("src/main/resources/testing/params_testing_no_covid_testing_file.txt");
		// start the simulation, which triggers the loading in of parameters
	...
	public static List<String> params() {
	    return Arrays.asList(
	            new String[]{"src/main/resources/testing/params_w_faulty_ODM.txt", "src/main/resources/testing/params_w_faulty_econ_status_movement_prob.txt",
	            		"src/main/resources/testing/params_w_faulty_econ_interactions.txt", "src/main/resources/testing/params_w_faulty_econ_distribution.txt",
	            		"src/main/resources/testing/params_w_faulty_linelist.txt", "src/main/resources/testing/params_w_faulty_inf_transitions.txt",
	            		"src/main/resources/testing/params_w_faulty_covid_test_numbers.txt", "src/main/resources/testing/params_w_faulty_covid_test_locations.txt"
	            		}
