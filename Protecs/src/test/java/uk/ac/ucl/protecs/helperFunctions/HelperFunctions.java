...
public class HelperFunctions {
	...
	public static void HaltDiseaseProgressionAtStage(WorldBankCovid19Sim world, CoronavirusBehaviourNodeTitle stage) {
		...
		case EXPOSED:
			...
			exp_idx = 0;
			for (double val: world.covidInfectiousFramework.getCovid_infection_r_sus_by_age()) {
				world.covidInfectiousFramework.getCovid_infection_r_sus_by_age().set(exp_idx, 0.0);
				exp_idx ++;
			}
