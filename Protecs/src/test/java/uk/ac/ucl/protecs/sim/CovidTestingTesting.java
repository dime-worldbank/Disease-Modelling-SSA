...
public class CovidTestingTesting {
	...
	public void OfficeWorkerBehaviours() {
		//Arrange
		WorldBankCovid19Sim sim = CreateDummySim(12345, "src/test/resources/params.txt", false);
		sim.start();
		...
		//Assert
		Assert.assertTrue(sut.atWorkNow()); // it is morning - they should not be at work
	}
