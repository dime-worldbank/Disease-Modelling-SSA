...
public class SingleRun {
	...
	public static void main(String [] args) {
		...
		String paramFilename = "src/test/resources/covid_testing_params.txt";
		// Create a name for the output file
		String outputFilename = "single_run_test" + timestamp.toString() + ".txt";
		...
		WorldBankCovid19Sim mySim = new WorldBankCovid19Sim(seed, new Params(paramFilename, false), outputFilename, false, true);
